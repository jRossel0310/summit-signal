    ...
    <div className="detail-page">
      <div className="detail-main contour-bg">
        ...
        <div className="detail-meta">
          ...
          {trip.gpx_route && (
            <span>
              GPX: {trip.gpx_route.length_miles?.toFixed(1)} mi
              {trip.gpx_route.min_elevation_ft != null &&
                `, ${Math.round(trip.gpx_route.min_elevation_ft).toLocaleString()}–${Math.round(trip.gpx_route.max_elevation_ft || 0).toLocaleString()} ft`}
            </span>
          )}
        </div>
